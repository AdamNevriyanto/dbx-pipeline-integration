...
This folder defines all source code for the 'dev_jeremi_cfmast' pipeline:
...
* Take a look at the sample under "sample_users_dev_jeremi_cfmast.py" to get familiar with the syntax.
